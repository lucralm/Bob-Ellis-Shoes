...
class woocommerce_store_pricing_rules_admin {
    ...
    function admin_register_head() {
        ...
        $url = $woocommerce_pricing->plugin_url() . '/assets/admin/admin.css';
        echo "<link rel='stylesheet' type='text/css' href='$url' />\n";
    }

    public function enqueue() {
        global $woocommerce_pricing;
        wp_enqueue_script('woocommerce-pricing-admin', $woocommerce_pricing->plugin_url() . '/assets/admin/admin.js', array('jquery'));
    }

    public function on_admin_menu() {
        $slug = add_submenu_page( 'woocommerce', __('Dynamic Pricing'), __('Dynamic Pricing'), 'manage_woocommerce', 'wc_dynamic_pricing', array(&$this, 'on_admin_page'));
    }
