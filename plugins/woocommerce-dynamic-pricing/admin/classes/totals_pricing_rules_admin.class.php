        ...
        public function create_rulesets($pricing_rule_sets) {
            ...
            foreach ($pricing_rule_sets as $name => $pricing_rule_set) {
                ...
                <div id="woocommerce-pricing-ruleset-<?php echo $name; ?>" class="woocommerce_pricing_ruleset <?php echo $validation_class; ?>">
                    <h4 class="first">Order Total Pricing<a href="#" data-name="<?php echo $name; ?>" class="delete_pricing_ruleset" ><img  src="<?php echo $woocommerce_pricing->plugin_url(); ?>/assets/images/delete.png" title="delete this set" alt="delete this set" style="cursor:pointer; margin:0 3px;float:right;" /></a></h4>    
