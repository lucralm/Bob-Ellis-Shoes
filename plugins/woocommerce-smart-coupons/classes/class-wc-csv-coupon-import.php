            ...
            class WC_CSV_Coupon_Import extends WP_Importer {
                ...
                */
                ...
                function header() {
                        ...
                        echo '<h2>' . __( 'Import Coupons', 'wc_csv_import' ) . '</h2>';
                }
                ...
                */
                function import( ){
                        ...
                        echo '<div class="updated settings-error below-h2"><p>
                                '.sprintf(__('Import complete - imported <strong>%s</strong>, merged <strong>%s</strong>, skipped <strong>%s</strong>', 'wc_smart_coupons'), $this->imported, $this->merged, $this->skipped ).'
                        </p></div>';
                ...
                */
                function import_end() {
                        ...
                        echo '<p>' . __( 'All done!', 'wc_smart_coupons' ) . ' <a href="' . admin_url('edit.php?post_type=shop_coupon') . '">' . __( 'View Coupons', 'wc_smart_coupons' ) . '</a>' . '</p>';
